                ...
                {answer.results.map((r, i) => (
                  ...
                  >
                    ...
                    <span style={{ textAlign: "right", fontFamily: theme.mono, color: theme.mint }}>
                      {r.overall_rating ?? (r.avg_rating ? parseFloat(r.avg_rating).toFixed(2) : null) ?? (r.average_rating ? parseFloat(r.average_rating).toFixed(2) : null) ?? r.hospital_count ?? r.count ?? r.num_hospitals ?? "—"}
                    </span>
                  </div>
                ))}
              </div>
